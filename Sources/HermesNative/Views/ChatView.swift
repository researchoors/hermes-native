...
struct ChatInputBar: View {
    ...
    /// Whether the gateway reports image support.  The attach button is always
    /// visible so the user can discover the feature; it disables with a tooltip
    /// when the gateway hasn't reported image capabilities.
    private var canAttachImages: Bool {
        capabilitiesStore.hasImageInput || capabilitiesStore.hasACPImagePrompts
    }
    ...
    private var attachButton: some View {
        ...
        Button {
            ...
            Image(systemName: "photo.badge.plus")
                ...
                .foregroundStyle(canAttachImages ? Theme.secondary : Theme.tertiary)
        ...
        .help(canAttachImages ? "Attach an image to your message" : "Gateway does not report image support")
        #else
        Menu {
            PhotosPicker(
                "Photo Library",
